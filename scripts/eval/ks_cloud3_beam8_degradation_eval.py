...
Output: eval_data/ks_cloud3_beam8_degradation_hyps.jsonl + docs/ks_cloud3_beam8_degradation.json
"""
import io
import json
import sys
...
OUT_JSONL   = ROOT / "eval_data" / "ks_cloud3_beam8_degradation_hyps.jsonl"
OUT_JSON    = ROOT / "docs" / "ks_cloud3_beam8_degradation.json"
...
def main():
    ...
    def transcribe(arr):
        ...
        with torch.no_grad():
            out = model.generate(**feat, tgt_lang="kas", num_beams=8,
