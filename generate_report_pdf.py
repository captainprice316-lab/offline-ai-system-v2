...
LANG_META = {
    "pa": {
        ...
        "steps": 1000, "baseline_wer": 105.83,
        "wer_curve": [(200,71.56),(400,65.83),(600,63.98),(800,62.08),(1000,61.30)],
    ...
    "ps": {
        ...
        "steps": 1000, "baseline_wer": 95.07,
        "wer_curve": [(200,41.62),(400,41.30),(600,38.91),(800,38.86),(1000,39.10)],
    ...
    "ne": {
        ...
        "steps": 1000, "baseline_wer": 94.55,
        "wer_curve": [(200,63.58),(400,56.87),(600,54.32),(800,54.55),(1000,54.36)],
...
EVAL_RESULTS = {
    "pa": {"baseline": 105.83, "ft": 59.94, "seamless": 19.77,  "nllb_chrf": 39.09, "sm_chrf": 58.72},
    "ps": {"baseline":  95.07, "ft": 39.72, "seamless": 44.40,  "nllb_chrf": 44.40, "sm_chrf": 43.92},
    "ur": {"baseline":  24.44, "ft": 19.82, "seamless": 16.90,  "nllb_chrf": 51.34, "sm_chrf": 54.91},
    "ne": {"baseline":  94.55, "ft": 53.92, "seamless": 28.46,  "nllb_chrf": 47.67, "sm_chrf": 56.02},
